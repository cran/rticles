...
\documentclass[$if(classoption)$$for(classoption)$$classoption$$sep$,$endfor$$else$utf8$endif$]{$documentclass$}
...
\onecolumn
\firstpage{$if(firstpage)$$firstpage$$else$1$endif$}
...
\tiny
 \keyFont{ \section{Keywords:} $for(keywords)$$keywords$$sep$, $endfor$} %All article types: you may provide up to 8 keywords; at least 5 are mandatory.
\end{abstract}
$endif$
